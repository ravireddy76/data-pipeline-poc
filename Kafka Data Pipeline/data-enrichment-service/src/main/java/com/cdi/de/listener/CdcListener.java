package com.cdi.de.listener;

import com.cdi.de.service.EventPublisher;
...
public class CdcListener {
    ...
    private void handleEvent(SourceRecord sourceRecord) {
        ...
        String topicName = StringUtils.substringAfterLast(sourceRecord.topic(),".");
        ...
        if(sourceRecordValue != null) {
            ...
            if(operation != Operation.READ) {
                ...
                this.eventPublisher.cdcPublish(topicName, message, operation);
