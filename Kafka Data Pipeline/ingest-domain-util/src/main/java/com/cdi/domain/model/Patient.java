...
public class Patient extends BaseEntity {
    ...
    @Nationalized
    @Column(name = "patient_info_enableVerterinary")
    private String patientInfoEnableVerterinary;
    ...
    @Nationalized
    @Column(name = "patient_info_resonForDeath")
    private String patientInfoResonForDeath;
