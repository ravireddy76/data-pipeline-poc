...
public class SwaggerConfig {
    ...
    public Docket apiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Patient Activities Ingest Service")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cdi.pa.di.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Patient Activities Ingest Service", "Patient Activities  Ingest Service"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Patient Activities Ingest Service")
                .description("Patient activities ingest service is micro service to ingest data into destination.")
                .contact(new Contact("Patient Activities Ingest Service", null, "ravi.nancherla@cdirad.com"))
                .version("2.0")
                .build();
    }
