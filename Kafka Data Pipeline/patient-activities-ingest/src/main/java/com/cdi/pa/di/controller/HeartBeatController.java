package com.cdi.pa.di.controller;
...
@Controller
@RequestMapping(value = "/patientactivities", produces = MediaType.APPLICATION_JSON_VALUE)
@Api(value = "/patientactivities", description = "Patient Activities Ingest Service")
@Slf4j
