...
public class SwaggerConfig {
    ...
    public Docket apiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Scheduling Office Ingest Service")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cdi.so.di.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Scheduling Office Ingest Service", "Scheduling Office Ingest Service"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Scheduling Office Ingest Service")
                .description("Scheduling office ingest service is micro service to ingest data into destination.")
                .contact(new Contact("Scheduling Office Ingest Service", null, "ravi.nancherla@cdirad.com"))
                .version("2.0")
                .build();
    }
