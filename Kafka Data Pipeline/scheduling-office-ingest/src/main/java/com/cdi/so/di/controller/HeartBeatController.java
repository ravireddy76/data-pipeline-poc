package com.cdi.so.di.controller;
...
@Controller
@RequestMapping(value = "/schedulingoffice", produces = MediaType.APPLICATION_JSON_VALUE)
@Api(value = "/schedulingoffice", description = "Scheduling Office Ingest Service")
@Slf4j
