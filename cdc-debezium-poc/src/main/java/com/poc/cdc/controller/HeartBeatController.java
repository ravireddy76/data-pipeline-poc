...
@Controller
@RequestMapping(value = "/cdcpoc", produces = MediaType.APPLICATION_JSON_VALUE)
@Api(value = "/cdcpoct", description = "Change Data Capture (CDC) Micro Service")
@Slf4j
public class HeartBeatController {

    /**
     * Method to get hear beat .
     *
