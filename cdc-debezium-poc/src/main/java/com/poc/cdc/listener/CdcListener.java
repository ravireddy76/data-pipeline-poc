package com.poc.cdc.listener;

import com.poc.cdc.service.EventPublisherService;
...
public class CdcListener {
     ...
     */
    private CdcListener(Configuration debeziumConnectorConfig, EventPublisherService eventPublisherService) {
    ...
    private void handleEvent(SourceRecord sourceRecord) {
        ...
        if(sourceRecordValue != null) {
            ...
            if(operation != Operation.READ) {
                ...
                this.eventPublisherService.publishEvents(message, operation);
