...
public class SwaggerConfig {
    ...
    public Docket apiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Data Enrichment Service")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.dp.poc.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Enrichment Service", "Enrichment service to demonstrate data processing"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Data Enrichment service a data processing micro service")
                .description("Data Enrichment service to demonstrate data processing.")
                .contact(new Contact("Data Enrichment service", null, "ravireddy76@gmail.com"))
                .version("2.0")
                .build();
    }
