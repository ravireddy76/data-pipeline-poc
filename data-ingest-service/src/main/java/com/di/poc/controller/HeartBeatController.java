...
@Controller
@RequestMapping(value = "/dataingest", produces = MediaType.APPLICATION_JSON_VALUE)
@Api(value = "/dataingest", description = "Data Ingest Service")
@Slf4j
